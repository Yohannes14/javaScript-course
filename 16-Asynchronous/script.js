...
//005 Our First AJAX Call_ XMLHttpRequest
...
5. This API allows you to make only 3 requests per second. If you reload fast, you will
 get this error with code 403. This is an error with the request. Remember, fetch() does NOT reject the promise in this case. So create an error to reject the promise yourself, with a meaningful error message.
...
get3Countries('ethiopia', 'canada', 'tanzania');
*/
/*
///////////////////////////////////////
